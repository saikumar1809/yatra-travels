...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1Ijoic2Fpa3VtYXIxODA5IiwiYSI6ImNrb3BxYXhiejBjM2Qydm9zOXVvYzE4ZmYifQ.BsycqaeOso6_FN-YV_wtFQ';
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            stripe = Stripe('pk_test_51IsWvJSIBMUzmCHzEkMjyscDgObxXCACq0r8VJAKrCAfRHUqoANlOcJWzMWPD7dyZz2gJXuYEpZxWNCtSkc10EDf00Q2KOoGS0'); // 1) Get checkout session from API
...
var bookBtn = document.getElementById('book-tour'); // const userPasswordForm = document.querySelector('.form-user-password');
// DELEGATION
...
if (userDataForm) userDataForm.addEventListener('submit', function (e) {
  ...
  console.log(form); // guard to check if different form submitted
...
if (bookBtn) bookBtn.addEventListener('click', function (e) {
  ...
  var tourId = e.currentTarget.dataset.tourId; //tour-id will automatically convert into tour Id
